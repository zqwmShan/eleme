<template>
    <div class="ratings" ref="rating">
    	<div class="ratings-content">
    		<div class="overview">
    			...
    			<div class="overview-right">
    				<div class="score-wrapper">
    					...
    					<span class="score">{{seller.service}}</span>
    				</div>
    				<div class="score-wrapper">
    		...
    		<split></split>
    		<ratingselect :select-type="selectType" :only-content="onlyContent" :ratings="ratings" @select-rating="selectRating" @toggle-content="toggleContent"></ratingselect>
